...
?>
    ...
    <body>
	<div>
        <form method="post" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" id="sPayForm">
		<h4>Payment Details</h4>
            <table>
                ...
                <tr>
                    ...
                    <td>: 							<input type="text" name="secret" id="secret4" placeholder="Subscription code"  required="">
</td>
                </tr>
            </table>
...
?>
	...
	</div></script><script src="js/jquery-modal.js"></script>
