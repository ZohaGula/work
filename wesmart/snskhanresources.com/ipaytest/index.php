				...
				<div class="changer-main">
					...
					<div class="about-block">
						<div class="changer-left wow bounceInLeft" data-wow-delay="0.1s">
							...
							<a href="#paymnt" rel="modal:open">
								<button class="pay fa btn btn-danger" data-orderId="ID001" data-MYRCode="1930" data-serviceTitle="Financial Courses &amp; Education">Add To Cart &nbsp;&nbsp;&nbsp;	&#xf218 1930 MYR</button>
							</a>
						</div>
					...
					<div class="changer-main">
						...
						<div class="about-block-snd">
							...
							<div class="changer-right-snd wow bounceInRight" data-wow-delay="0.1s">
								...
								<a href="#paymnt" rel="modal:open">
									<button class="pay fa btn btn-danger" data-orderId="ID002" data-MYRCode="2330" data-serviceTitle="Detailed calculations &amp; Calculators">Add To Cart &nbsp;&nbsp;&nbsp; &#xf218 2330 MYR</button></a>
					...
					<div class="about-block agileits-w3layouts">
						<div class="changer-left-trd wow bounceInLeft" data-wow-delay="0.1s">
							...
							<p>This course is designed for anyone wishing to have better results in negotiation, deal-making, and conflict resolution,
								be it in formal or informal situations. Students, managers, lawyers, public officials, etc., have found its content
								useful.
							</p>
							<a href="#paymnt" rel="modal:open">
								<button class="pay fa btn btn-danger" data-orderId="ID003"  data-MYRCode="2710" data-serviceTitle="Financial Negotiation">Add To Cart &nbsp;&nbsp;&nbsp;&#xf218 2710 MYR</button>
							</a>
				...
				<div class="changer-main">
					...
					<div class="about-block-snd">
						...
						<div class="changer-right-snd wow bounceInRight" data-wow-delay="0.1s">
							...
							<a href="#paymnt" rel="modal:open">
								<button class="pay fa btn btn-danger" data-orderId="ID004" data-MYRCode="3100" data-serviceTitle="Financial Planning"> Add To Cart &nbsp;&nbsp;&nbsp;&#xf218 3100 MYR</button>
							</a>
				...
				<div class="changer-main">
					...
					<div class="about-block-snd">
						...
						<div class="changer-right-snd wow bounceInRight" data-wow-delay="0.1s">
							...
							<p>Most people have more than one debt. You may have high intrigue credit cards, credits and home loans. To pay off one
								debt you may need to get from another person, making yet another debt. The answer for this issue is an debt consolidation
								home loan credit. We can enable you to merge your debt and lower your installments by taking out the regularly scheduled
								installments related with your credit cards and debt. This is likewise the initial phase in enhancing your credit
								ratings as whenever you use more than 50% of your accessible Credit card balances, you are causing a diminishment
								in your scores.</p>
							<a href="#paymnt" rel="modal:open">
								<button class="pay fa btn btn-danger" data-orderId="ID005"  data-MYRCode="3480" data-serviceTitle="Debt Consolidation" >Add To Cart &nbsp;&nbsp;&nbsp; &#xf218 3480 MYR </button>
							</a>
						</div>
						<div class="clearfix"> </div>
						<div class="ch-bott1 agile">
					...
					<div class="about-block agileits-w3layouts">
						<div class="changer-left-trd wow bounceInLeft" data-wow-delay="0.1s">
							...
							<p>According to us every individual needs a personal financial advisor/consultant which can help those people who have
								...
								of risk possible.</p>
							<a href="#paymnt" rel="modal:open">
								<button class="pay fa btn btn-danger" data-orderId="ID006" data-MYRCode="3870" data-serviceTitle="Financial Consultancy">Add To Cart &nbsp;&nbsp;&nbsp; &#xf218; 3870 MYR</button>
							</a>
							...
							<div class="contact-top" id="paymnt" style="display: none;">
								...
								<div class="contact-bottom">
									...
									<select name="paymenMethod" style="width:40%" class="btn btn-secondary btn-lg " id="paymenMethod" onchange="checkPayMethod(this)">
										...
										<option value="other" >JPay</option>
										<option value="molpay">1Pay</option>
										<option value="hpay">HPay</option>
									</select>
									<br>
									<script>
									...
									<form style="display:none" action="./paymentAPI/molpay.php" method="post" id="molpay">
										...
										<div class="contact-right contact-left agileinfo">
											...
											<input type="text" name="secret" id="secret1" placeholder="Subscription code"  required="">
											...
											<input type="submit" value="Confirm" name="molpaySubmit" id="confirm1">
									...
									<form style="display:none" action="./paymentAPI/Hpay.php" method="post" id="hpay">
										<div class="contact-left agileinfo">
											...
											<input type="text" name="​bill_name" placeholder="Full Name" required="" id="​bill_name"><br>
											<input type="date" name="_date" id="birthDate1">
											<input type="text" name="amount" id="amount3"  placeholder="Payment" readonly="readonly" required=""><br>
				...
				<div class="changer-main">
					...
					<div class="about-block-snd">
						...
						<div class="changer-right-snd wow bounceInRight" data-wow-delay="0.1s">
							...
							<p>We are continually checking for new offers and have chosen the best arrangements for you. very couple of things in
								life are free. In any case, on the off chance that you pay off your obligation utilizing a no expense, 0% APR adjust
								exchange, you can pulverize your Visa and Master's obligation without paying a dime to the bank. </p> <br> <br> <br>

							<a href="#paymnt" rel="modal:open">
								<button class="pay fa btn btn-danger" data-orderId="ID007"  data-MYRCode="4260" data-serviceTitle="Balanace Transferring"> Add To Cart &nbsp;&nbsp;&nbsp; &#xf218 4260 MYR</button>
							</a>
						</div>
						<div class="clearfix"> </div>
						<div class="ch-bott1 agile">
				...
				<div class="changer-main">
					...
					<div class="about-block agileits-w3layouts">
						<div class="changer-left-trd wow bounceInLeft" data-wow-delay="0.1s">
							...
							<p>The prime rate is the financing cost that business banks charge their most credit-commendable clients. By and large,
								a bank's best clients comprise of expansive enterprises. The prime financing cost, or prime loaning rate, is generally
								dictated by the government stores rate, which is the overnight rate that banks use to loan to each other; the prime
								rate is additionally essential for singular borrowers, as the prime rate specifically influences the loaning rates
								accessible for a home loan, private company credit or individual advance.</p>
							<a href="#paymnt" rel="modal:open">
								<button class="pay fa btn btn-danger" data-orderId="ID008" data-MYRCode="4650" data-serviceTitle="Reduction High Rates To Prime Rates"> Add To Cart &nbsp;&nbsp;&nbsp; &#xf218 4650 MYR</button>
							</a>
						</div>
						<div class="changer-right-trd wow bounceInRight" data-wow-delay="0.1s">
					...
					<div class="col-md-12 features-left wthree">
						<div class="fea-agileits wow bounceInLeft" data-wow-delay="0.1s">
							<div class="fea-left-top">
								...
								<p> Refunds / Returns requested more than 10 days after your hidden purchase date won't be issued unless the trade was
