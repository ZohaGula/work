...
if( isset($_POST['hpayconfirm']) ){
    ...
    if($run_insert){        
        ...
        <FORM method="post" id="ePayment" name="ePayment" action="https://www.mobile88.com/ePayment/entry.asp">
            ...
            <INPUT type="hidden" name="ResponseURL" value="https://snskhanresources.com/ipaytest/response.php">
            <INPUT type="hidden" name="BackendURL" value="https://snskhanresources.com/ipaytest/backend_response.php">
        </FORM>
        <script>
